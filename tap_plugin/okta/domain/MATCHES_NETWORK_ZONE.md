# Matches Network Zone

## Blurb

A policy rule's network condition names a zone, to include or exclude requests from it.

## Purpose

Show which networks a rule trusts or excludes.
...
- targets: `okta__okta_network_zone`
