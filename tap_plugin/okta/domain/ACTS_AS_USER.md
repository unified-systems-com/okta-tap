...
An API token authenticates as the user who created it and carries that user's admin permissions at the moment of each call. Deactivating the user revokes the token.

## Purpose

Tie an API token to the user whose permissions it carries.
