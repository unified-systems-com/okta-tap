# Holds Role Assignment

## Blurb

A user, a group or a service application holds an admin role assignment. For a group, every member holds it.

## Purpose

Join a principal to its admin role assignments.
