...
- The `/okta` page: the org as a picture (applications, groups, policies with their rules, authenticators, federation, administration), then fifteen tables. `?org=<org name>` picks the org; absent, every org on the grid is shown.
